...
--run-mode test \
--data-test \
each:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/dy/*.root \
each:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/ggh/*.root \
each:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/vbf/*.root \
--data-config data_pheno/hmm/hmm_vbf.yaml \
--model-prefix model/hmm_vbf_small/net \
--predict-output predict/hmm_vbf_small_each/pred.root \
