...
--run-mode train,val \
--data-train \
vbf:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/vbf_finetuning/*.root \
dy:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/dy_finetuning/dy_filtered_0.root \
dy:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/dy_finetuning/dy_filtered_1.root \
dy:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/dy_finetuning/dy_filtered_2.root \
dy:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/dy_finetuning/dy_notfiltered_1.root \
dy:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/dy_finetuning/dy_notfiltered_11.root \
dy:/afs/ihep.ac.cn/users/k/kouhao/pub/sample/vbf_phasespace/dy_finetuning/dy_notfiltered_21.root \
--data-config data_pheno/hmm/hmm_vbf_weight.yaml \
--model-prefix model/hmm_vbf_small_weight/net \
--predict-output predict/hmm_vbf_small_weight/pred.root \
--log-file logs/hmm_vbf_small_weight.log \
--tensorboard tensorboard/hmm_vbf_small_weight \
--load-epoch 23"
