...
--run-mode test \
--data-test \
ggh:/publicfs/cms/user/kouhao/sample/vbf_phasespace/ggh_test_finetuning/ggh*.root \
vbf:/publicfs/cms/user/kouhao/sample/vbf_phasespace/vbf_test_finetuning/vbf*.root \
dy:/publicfs/cms/user/kouhao/sample/vbf_phasespace/dy_test_finetuning/dy*.root \
